...
for old,new in {
    'com.google.android.gms:play-services-location:21.3.0':'com.google.android.gms:play-services-location:21.4.0',
    'com.google.android.gms:play-services-maps:19.0.0':'com.google.android.gms:play-services-maps:20.0.0',
}.items():
...
print('Applied JobBubble V9.4.79 location 21.4.0 + Maps 20.0.0; kept auth 21.3.0 and added legacy HTTP compatibility declaration')
